...
- [SSOT Core Architecture](../ssot_core/ARCHITECTURE.md)
- [Ingestion Pipeline](INGESTION_PIPELINE.md)
- [Semantic Intelligence Layer](SEMANTIC_LAYER.md)
- [DesktopCam Forensic Recorder](DESKTOPCAM.md)
- [Global Chat Ingestion Layer](GLOBAL_CHAT_INGESTION.md)
...
- [Acquisition Readiness](ACQUISITION_READINESS.md)

## Related Existing Technical Docs

- [Provider Plugin System](provider_plugin_system.md)
- [Cross Platform Architecture](cross_platform_architecture.md)
- [Source Tracking](source_tracking.md)
- [Semantic + DesktopCam Early Design](SSOT_INTELLIGENCE_DESKTOPCAM_ARCHITECTURE.md)
